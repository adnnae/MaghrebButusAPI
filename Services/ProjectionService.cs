...
namespace MaghrebButusAPI.Services
{
    ...
    public class ProjectionService
    {
        ...
        private static readonly Dictionary<int, string> WktDefinitions = new()
        {
            ...
            [26191] = "PROJCS[\"Merchich / Nord Maroc\",GEOGCS[\"Merchich\",DATUM[\"Merchich\",SPHEROID[\"Clarke 1880 (IGN)\",6378249.2,293.4660212936265],TOWGS84[31,146,47,0,0,0,0]],PRIMEM[\"Greenwich\",0],UNIT[\"degree\",0.0174532925199433]],PROJECTION[\"Lambert_Conformal_Conic_2SP\"],PARAMETER[\"standard_parallel_1\",31.73],PARAMETER[\"standard_parallel_2\",34.87],PARAMETER[\"latitude_of_origin\",33.3],PARAMETER[\"central_meridian\",-5.4],PARAMETER[\"false_easting\",500000],PARAMETER[\"false_northing\",300000],UNIT[\"metre\",1]]",

            [26192] = "PROJCS[\"Merchich / Sud Maroc\",GEOGCS[\"Merchich\",DATUM[\"Merchich\",SPHEROID[\"Clarke 1880 (IGN)\",6378249.2,293.4660212936265],TOWGS84[31,146,47,0,0,0,0]],PRIMEM[\"Greenwich\",0],UNIT[\"degree\",0.0174532925199433]],PROJECTION[\"Lambert_Conformal_Conic_2SP\"],PARAMETER[\"standard_parallel_1\",28.04],PARAMETER[\"standard_parallel_2\",31.36],PARAMETER[\"latitude_of_origin\",29.7],PARAMETER[\"central_meridian\",-5.4],PARAMETER[\"false_easting\",500000],PARAMETER[\"false_northing\",300000],UNIT[\"metre\",1]]",

            [26194] = "PROJCS[\"Merchich / Sahara\",GEOGCS[\"Merchich\",DATUM[\"Merchich\",SPHEROID[\"Clarke 1880 (IGN)\",6378249.2,293.4660212936265],TOWGS84[31,146,47,0,0,0,0]],PRIMEM[\"Greenwich\",0],UNIT[\"degree\",0.0174532925199433]],PROJECTION[\"Lambert_Conformal_Conic_2SP\"],PARAMETER[\"standard_parallel_1\",24.29],PARAMETER[\"standard_parallel_2\",27.91],PARAMETER[\"latitude_of_origin\",26.1],PARAMETER[\"central_meridian\",-5.4],PARAMETER[\"false_easting\",1200000],PARAMETER[\"false_northing\",400000],UNIT[\"metre\",1]]",
            ...
            [32635] = "PROJCS[\"WGS 84 / UTM zone 35N\",GEOGCS[\"WGS 84\",DATUM[\"WGS_1984\",SPHEROID[\"WGS 84\",6378137,298.257223563]],PRIMEM[\"Greenwich\",0],UNIT[\"degree\",0.0174532925199433]],PROJECTION[\"Transverse_Mercator\"],PARAMETER[\"latitude_of_origin\",0],PARAMETER[\"central_meridian\",27],PARAMETER[\"scale_factor\",0.9996],PARAMETER[\"false_easting\",500000],PARAMETER[\"false_northing\",0],UNIT[\"metre\",1]]",

            [32636] = "PROJCS[\"WGS 84 / UTM zone 36N\",GEOGCS[\"WGS 84\",DATUM[\"WGS_1984\",SPHEROID[\"WGS 84\",6378137,298.257223563]],PRIMEM[\"Greenwich\",0],UNIT[\"degree\",0.0174532925199433]],PROJECTION[\"Transverse_Mercator\"],PARAMETER[\"latitude_of_origin\",0],PARAMETER[\"central_meridian\",33],PARAMETER[\"scale_factor\",0.9996],PARAMETER[\"false_easting\",500000],PARAMETER[\"false_northing\",0],UNIT[\"metre\",1]]",

            [32637] = "PROJCS[\"WGS 84 / UTM zone 37N\",GEOGCS[\"WGS 84\",DATUM[\"WGS_1984\",SPHEROID[\"WGS 84\",6378137,298.257223563]],PRIMEM[\"Greenwich\",0],UNIT[\"degree\",0.0174532925199433]],PROJECTION[\"Transverse_Mercator\"],PARAMETER[\"latitude_of_origin\",0],PARAMETER[\"central_meridian\",39],PARAMETER[\"scale_factor\",0.9996],PARAMETER[\"false_easting\",500000],PARAMETER[\"false_northing\",0],UNIT[\"metre\",1]]",

            [30791] = "PROJCS[\"Nord Sahara 1959 / Nord Algerie\",GEOGCS[\"Nord Sahara 1959\",DATUM[\"Nord_Sahara_1959\",SPHEROID[\"Clarke 1880 (RGS)\",6378249.145,293.465],TOWGS84[-186,-93,310,0,0,0,0]],PRIMEM[\"Greenwich\",0],UNIT[\"degree\",0.0174532925199433]],PROJECTION[\"Lambert_Conformal_Conic_2SP\"],PARAMETER[\"standard_parallel_1\",34.39],PARAMETER[\"standard_parallel_2\",37.61],PARAMETER[\"latitude_of_origin\",36],PARAMETER[\"central_meridian\",2.7],PARAMETER[\"false_easting\",500135],PARAMETER[\"false_northing\",300090],UNIT[\"metre\",1]]",

            [30792] = "PROJCS[\"Nord Sahara 1959 / Sud Algerie\",GEOGCS[\"Nord Sahara 1959\",DATUM[\"Nord_Sahara_1959\",SPHEROID[\"Clarke 1880 (RGS)\",6378249.145,293.465],TOWGS84[-186,-93,310,0,0,0,0]],PRIMEM[\"Greenwich\",0],UNIT[\"degree\",0.0174532925199433]],PROJECTION[\"Lambert_Conformal_Conic_2SP\"],PARAMETER[\"standard_parallel_1\",31.73],PARAMETER[\"standard_parallel_2\",34.87],PARAMETER[\"latitude_of_origin\",33.3],PARAMETER[\"central_meridian\",2.7],PARAMETER[\"false_easting\",500135],PARAMETER[\"false_northing\",300090],UNIT[\"metre\",1]]",

            [22391] = "PROJCS[\"Carthage / Nord Tunisie\",GEOGCS[\"Carthage\",DATUM[\"Carthage\",SPHEROID[\"Clarke 1880 (IGN)\",6378249.2,293.4660212936265],TOWGS84[-263,6,431,0,0,0,0]],PRIMEM[\"Greenwich\",0],UNIT[\"degree\",0.0174532925199433]],PROJECTION[\"Lambert_Conformal_Conic_2SP\"],PARAMETER[\"standard_parallel_1\",34.39],PARAMETER[\"standard_parallel_2\",37.61],PARAMETER[\"latitude_of_origin\",36],PARAMETER[\"central_meridian\",9.9],PARAMETER[\"false_easting\",500000],PARAMETER[\"false_northing\",300000],UNIT[\"metre\",1]]",

            [22392] = "PROJCS[\"Carthage / Sud Tunisie\",GEOGCS[\"Carthage\",DATUM[\"Carthage\",SPHEROID[\"Clarke 1880 (IGN)\",6378249.2,293.4660212936265],TOWGS84[-263,6,431,0,0,0,0]],PRIMEM[\"Greenwich\",0],UNIT[\"degree\",0.0174532925199433]],PROJECTION[\"Lambert_Conformal_Conic_2SP\"],PARAMETER[\"standard_parallel_1\",31.73],PARAMETER[\"standard_parallel_2\",34.87],PARAMETER[\"latitude_of_origin\",33.3],PARAMETER[\"central_meridian\",9.9],PARAMETER[\"false_easting\",500000],PARAMETER[\"false_northing\",300000],UNIT[\"metre\",1]]",
        };
