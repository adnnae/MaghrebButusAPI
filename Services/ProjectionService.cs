...
namespace MaghrebButusAPI.Services
{
    ...
    public class ProjectionService
    {
        ...
        private static readonly Dictionary<int, string> WktDefinitions = new()
        {
            ...
            [26191] = "PROJCS[\"Merchich / Nord Maroc\",GEOGCS[\"Merchich\",DATUM[\"Merchich\",SPHEROID[\"Clarke 1880 (IGN)\",6378249.2,293.4660212936265],TOWGS84[31,146,47,0,0,0,0]],PRIMEM[\"Greenwich\",0],UNIT[\"degree\",0.0174532925199433]],PROJECTION[\"Lambert_Conformal_Conic_2SP\"],PARAMETER[\"standard_parallel_1\",33.3],PARAMETER[\"standard_parallel_2\",33.3],PARAMETER[\"latitude_of_origin\",33.3],PARAMETER[\"central_meridian\",-5.4],PARAMETER[\"false_easting\",500000],PARAMETER[\"false_northing\",300000],UNIT[\"metre\",1]]",

            [26192] = "PROJCS[\"Merchich / Sud Maroc\",GEOGCS[\"Merchich\",DATUM[\"Merchich\",SPHEROID[\"Clarke 1880 (IGN)\",6378249.2,293.4660212936265],TOWGS84[31,146,47,0,0,0,0]],PRIMEM[\"Greenwich\",0],UNIT[\"degree\",0.0174532925199433]],PROJECTION[\"Lambert_Conformal_Conic_2SP\"],PARAMETER[\"standard_parallel_1\",29.7],PARAMETER[\"standard_parallel_2\",29.7],PARAMETER[\"latitude_of_origin\",29.7],PARAMETER[\"central_meridian\",-5.4],PARAMETER[\"false_easting\",500000],PARAMETER[\"false_northing\",300000],UNIT[\"metre\",1]]",

            [26194] = "PROJCS[\"Merchich / Sahara\",GEOGCS[\"Merchich\",DATUM[\"Merchich\",SPHEROID[\"Clarke 1880 (IGN)\",6378249.2,293.4660212936265],TOWGS84[31,146,47,0,0,0,0]],PRIMEM[\"Greenwich\",0],UNIT[\"degree\",0.0174532925199433]],PROJECTION[\"Lambert_Conformal_Conic_2SP\"],PARAMETER[\"standard_parallel_1\",26.1],PARAMETER[\"standard_parallel_2\",26.1],PARAMETER[\"latitude_of_origin\",26.1],PARAMETER[\"central_meridian\",-5.4],PARAMETER[\"false_easting\",1200000],PARAMETER[\"false_northing\",400000],UNIT[\"metre\",1]]",
            ...
            [30791] = "PROJCS[\"Nord Sahara 1959 / Nord Algerie\",GEOGCS[\"Nord Sahara 1959\",DATUM[\"Nord_Sahara_1959\",SPHEROID[\"Clarke 1880 (RGS)\",6378249.145,293.465],TOWGS84[-186,-93,310,0,0,0,0]],PRIMEM[\"Greenwich\",0],UNIT[\"degree\",0.0174532925199433]],PROJECTION[\"Lambert_Conformal_Conic_2SP\"],PARAMETER[\"standard_parallel_1\",36],PARAMETER[\"standard_parallel_2\",36],PARAMETER[\"latitude_of_origin\",36],PARAMETER[\"central_meridian\",2.7],PARAMETER[\"false_easting\",500135],PARAMETER[\"false_northing\",300090],UNIT[\"metre\",1]]",

            [30792] = "PROJCS[\"Nord Sahara 1959 / Sud Algerie\",GEOGCS[\"Nord Sahara 1959\",DATUM[\"Nord_Sahara_1959\",SPHEROID[\"Clarke 1880 (RGS)\",6378249.145,293.465],TOWGS84[-186,-93,310,0,0,0,0]],PRIMEM[\"Greenwich\",0],UNIT[\"degree\",0.0174532925199433]],PROJECTION[\"Lambert_Conformal_Conic_2SP\"],PARAMETER[\"standard_parallel_1\",33.3],PARAMETER[\"standard_parallel_2\",33.3],PARAMETER[\"latitude_of_origin\",33.3],PARAMETER[\"central_meridian\",2.7],PARAMETER[\"false_easting\",500135],PARAMETER[\"false_northing\",300090],UNIT[\"metre\",1]]",

            [22391] = "PROJCS[\"Carthage / Nord Tunisie\",GEOGCS[\"Carthage\",DATUM[\"Carthage\",SPHEROID[\"Clarke 1880 (IGN)\",6378249.2,293.4660212936265],TOWGS84[-263,6,431,0,0,0,0]],PRIMEM[\"Greenwich\",0],UNIT[\"degree\",0.0174532925199433]],PROJECTION[\"Lambert_Conformal_Conic_2SP\"],PARAMETER[\"standard_parallel_1\",36],PARAMETER[\"standard_parallel_2\",36],PARAMETER[\"latitude_of_origin\",36],PARAMETER[\"central_meridian\",9.9],PARAMETER[\"false_easting\",500000],PARAMETER[\"false_northing\",300000],UNIT[\"metre\",1]]",

            [22392] = "PROJCS[\"Carthage / Sud Tunisie\",GEOGCS[\"Carthage\",DATUM[\"Carthage\",SPHEROID[\"Clarke 1880 (IGN)\",6378249.2,293.4660212936265],TOWGS84[-263,6,431,0,0,0,0]],PRIMEM[\"Greenwich\",0],UNIT[\"degree\",0.0174532925199433]],PROJECTION[\"Lambert_Conformal_Conic_2SP\"],PARAMETER[\"standard_parallel_1\",33.3],PARAMETER[\"standard_parallel_2\",33.3],PARAMETER[\"latitude_of_origin\",33.3],PARAMETER[\"central_meridian\",9.9],PARAMETER[\"false_easting\",500000],PARAMETER[\"false_northing\",300000],UNIT[\"metre\",1]]",
        };
